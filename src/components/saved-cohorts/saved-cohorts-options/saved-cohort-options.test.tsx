...
describe('Test the saved cohorts options', () => {
  it('should be able to view the saved cohort', async () => {
    ...
    render(<SavedCohortsOptions cohort={cohort} onViewCohort={onViewCohort} onDeleteCohort={jest.fn()} />);
  ...
  it('should be able delete a cohort', async () => {
    ...
    render(<SavedCohortsOptions cohort={cohort} onViewCohort={jest.fn()} onDeleteCohort={onDeleteCohort} />);
